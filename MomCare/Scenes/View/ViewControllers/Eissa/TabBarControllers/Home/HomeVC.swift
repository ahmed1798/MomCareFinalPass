...
class HomeVC: UIViewController {
    ...
    var isSelectedExamination = false // select or select examination
    var examinationArray = ["الحميراء", "فحص دم الجنين", "فحص دم الجنين في الثلث الاول من الحمل"]
    ...
    override func viewDidLoad() {
        ...
        self.goToProfile.setBackgroundImage(UIImage(named: "arrow_open"), for: .normal)
    ...
    func setupSegmenttedControl() {
        if lang == "en" {
             ...
             segmentedControll.buttonTitles = ["الحمل", "صحه الحامل", "الجنين"]
        }
    ...
    @IBAction func segmentedControllTapped(_ sender: Any) {
        ...
        if segmentedControll.selectedSegmentIndex == 0 {
            ...
            moreInfoTextField.text = "يجب ان تاكلي اكل صحي ومفيد وتمارسي الرياضه بشكل يومي وتجري التحاليل الازمه في هذا الشهر"
        }
        else  {
            // handle what happen in The fetus index
            moreInfoTextField.text = "جنينك الان اصبح بحجم حبه الليمون او الخوخ طوله ٨٫٧ سم تقريبا وبين ما يقارب ٤٣ غم "
        }
    }

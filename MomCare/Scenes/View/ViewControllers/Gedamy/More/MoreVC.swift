...
class MoreVC: UIViewController {
    ...
    @IBOutlet weak var pregnancySafety: UIView!
...
//        self.logOutBu.layer.cornerRadius = 20.0
        ...
        let tapGesture5 = UITapGestureRecognizer(target: self, action: #selector(handlePregnancySafetyViewTap(sender:)))
        pregnancySafety.addGestureRecognizer(tapGesture5)
    }
    ...
    @objc func handlePregnancySafetyViewTap(sender: UITapGestureRecognizer) {
        let vc = PregnancySafetyVC(nibName: "PregnancySafetyVC", bundle: nil)

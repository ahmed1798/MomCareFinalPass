    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == doctorsCollectionView{
            ...
            if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "AllOfObjectsCVCell", for: indexPath) as? AllOfObjectsCVCell{
                ...
                if lang == "ar"{
                    cell.titleLbl.text = self.titleArrAr[indexPath.row]
                    return cell
                }else{
                    cell.titleLbl.text = self.titleArrEn[indexPath.row]
                    return cell
                }
            }else{
                return UICollectionViewCell()
            ...
            if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "MostReadingCVCell", for: indexPath) as? MostReadingCVCell{
                ...
                if lang == "en"{
                    cell.lable.text = self.titlesEn[indexPath.row]
                return cell
                }else{
                    cell.lable.text = self.titlesAr[indexPath.row]
                    return cell
                }
            }else{
                return UICollectionViewCell()
...
extension MedicalGuideVC:UICollectionViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if collectionView == mostReadingCollectionView{
            ...
            if lang == "ar"{
                vc.desc = self.descArrAR[indexPath.row]
                vc.headTitle = self.titlesAr[indexPath.row]
            }else{
                vc.desc = self.descEn[indexPath.row]
                vc.headTitle = self.titlesEn[indexPath.row]
            }
        ...
        if collectionView == allObjctsCollectionView{
                ...
                case 0:
                    URLExtensions.openURL(url: "https://www.altebby.com/برنامج-أنت%D9%90-وطفلك-للعناية-بالطفل-من-ي/")
                case 1:
                    URLExtensions.openURL(url: "https://www.elevitarabia.com/ar/breastfeeding/")
            
                case 2:
                    URLExtensions.openURL(url: "https://www.mayoclinic.org/ar/healthy-lifestyle/labor-and-delivery/in-depth/stages-of-labor/art-20046545")
                    
                case 3:
                    URLExtensions.openURL(url: "https://www.unicef.org/arabic/health/health_42779.html")
                
                case 4:
                     URLExtensions.openURL(url: "https://www.health.gov.il/Arabic/Subjects/pregnancy/during/Pages/proper_nutrition_during_pregnancy.aspx")

                case 5:
                    URLExtensions.openURL(url: "https://www.doctoori.net/pregnancy-birth/labour-and-birth/pregnancybirthbeyond-for-dad.html")
